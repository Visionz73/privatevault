<?php
// templates/navbar.php (without mobile formatting)
...
<style>
  ...
  /* Mobile formatting removed */
</style>
<nav id="sidebar" class="bg-white/80 backdrop-blur-sm border-r border-white/60 shadow-lg fixed left-0 top-0 bottom-0 w-64 flex flex-col">

...
<head>
    ...
    <style>
        ...
        * {
        ...
        html {
            font-size: 14px; /* Reduced base font size for 80% effect */
        }
        ...
        body {
            ...
            zoom: 0.8; /* Overall scaling for 80% effect */
        }
...
<body>
    ...
    <!-- Modern Compact Sidebar -->
    <nav class="compact-sidebar" id="compactSidebar">
        ...
        <div class="sidebar-nav">
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="index.php" class="modern-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : ''; ?>">
                ...
                <div class="nav-item">
                    <a href="taskboard.php" class="modern-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'taskboard.php' ? 'active' : ''; ?>">
                ...
                <div class="nav-item">
                    <a href="havetopay.php" class="modern-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'havetopay.php' ? 'active' : ''; ?>">
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="profile.php" class="modern-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'profile.php' ? 'active' : ''; ?>">
                ...
                <div class="nav-item">
                    <a href="settings.php" class="modern-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'settings.php' ? 'active' : ''; ?>">
